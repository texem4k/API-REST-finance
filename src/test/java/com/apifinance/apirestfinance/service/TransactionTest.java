...
public class TransactionTest {
    ...
    public void setCorrectCategoryToTransactionTest(){
        ...
        Transaction transaction2 = Transaction.createTransaction("Transacción ejemplo", BigDecimal.valueOf(50), userService.findAllUsers(pageable).stream().findFirst().get(),"hola", TransactionType.EXPENSE);
